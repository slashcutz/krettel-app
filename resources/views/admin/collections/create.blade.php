        ...
        <form action="{{ route('admin.collections.store') }}" method="POST" enctype="multipart/form-data" class="p-4 sm:p-6">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="terabox_image" id="terabox_image" value="{{ old('terabox_image') }}" placeholder="https://... or pixeldrain://file-id" class="bg-secondary border border-border text-white text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5">
