    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="px-4 space-y-2">
                <a href="{{ route('login') }}" class="block font-medium text-base text-gray-800 dark:text-gray-200">Log in</a>
                <a href="{{ route('register') }}" class="block font-medium text-base text-gray-800 dark:text-gray-200">Register</a>
            </div>
            @endauth
        </div>
    </div>
