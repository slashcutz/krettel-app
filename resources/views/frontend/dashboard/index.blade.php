<x-app-layout>
    <div class="pt-24 pb-12 max-w-7xl mx-auto sm:px-6 lg:px-8 min-h-screen">
        <div class="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4 md:gap-0">
            <h1 class="text-2xl md:text-3xl font-bold text-white leading-tight">Welcome back, {{ $user->name }}!</h1>
